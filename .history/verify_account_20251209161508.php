...
class EmailNotification {
    ...
    private function getEmailTemplate($content, $title) {
        ...
        <head>
            <style>
                ...
                .email-header { background: #667eea; color: white; padding: 20px; border-radius: 8px 8px 0 0; text-align: center; }
                .email-header h1 { margin: 0; font-size: 24px; }
                .email-header p { margin: 10px 0 0 0; font-size: 14px; opacity: 0.9; }
                .email-body { padding: 20px; background: #f5f7fa; }
                .email-footer { background: #f5f7fa; padding: 20px; border-radius: 0 0 8px 8px; text-align: center; font-size: 12px; color: #666; border-top: 1px solid #ddd; }
                .highlight { background: #fff; padding: 15px; border-left: 4px solid #667eea; margin: 15px 0; border-radius: 4px; }
                i { margin-right: 8px; }
            </style>
        </head>
        <body>
    ...
    public function sendWarrantyExpiringEmail($email, $owner_name, $appliance_name, $days_left, $warranty_end_date) {
        $subject = "<i class='fas fa-exclamation-circle'></i> Warranty Expiring Soon - {$appliance_name}";
