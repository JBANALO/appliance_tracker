        ...
        <form action="" method="post">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="owner_name" id="owner_id" required>
                        <option value="">--Select Owner--</option>
                        <?php 
                        if ($owners && count($owners) > 0) {
                            foreach ($owners as $owner) {
                                $selected = ($appliance["owner_name"] == $owner["owner_name"]) ? "selected" : "";
                                echo "<option value='{$owner["owner_name"]}' {$selected}>{$owner["owner_name"]} ({$owner["email"]})</option>";
                            }
                        }
                        ?>
                    </select>
